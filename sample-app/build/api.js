  ...
  router.post(
    ...
    (function() {
      var _ref = _asyncToGenerator(function*(req, res) {
        var person = yield _Person2.default
          .query()
  ...
  router.get(
    ...
    (function() {
      var _ref3 = _asyncToGenerator(function*(req, res) {
        ...
        var persons = yield _Person2.default
          .query()
  ...
  router.post(
    ...
    (function() {
      var _ref8 = _asyncToGenerator(function*(req, res) {
        ...
        var movie = yield (0, _objection.transaction)(
          _Person2.default.knex(),
          (function() {
